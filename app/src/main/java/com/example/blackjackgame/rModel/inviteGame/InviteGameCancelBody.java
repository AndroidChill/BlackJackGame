...
public class InviteGameCancelBody {
    ...
    public InviteGameCancelBody(String menu, String status, String statusText, String token, String captchaImageUrl, String popup) {
        this.menu = menu;
        this.status = status;
