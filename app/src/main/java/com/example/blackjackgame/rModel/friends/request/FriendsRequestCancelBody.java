...
public class FriendsRequestCancelBody {
    ...
    public FriendsRequestCancelBody(String menu, String status, String statusText, String token, String captchaImageUrl, String popup) {
        this.menu = menu;
        this.status = status;
