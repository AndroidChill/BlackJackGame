...
public class RatingRichBody {
    ...
    public RatingRichBody(String menu, String status, String statusText, String token, String captchaImageUrl, String popup, RatingUser user, List<RatingOtherUser> users) {
        this.menu = menu;
        this.status = status;
