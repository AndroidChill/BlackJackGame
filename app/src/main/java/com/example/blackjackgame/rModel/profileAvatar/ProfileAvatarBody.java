...
public class ProfileAvatarBody {
    ...
    public ProfileAvatarBody(String menu, String status, String statusText, String token, String captchaImageUrl, String popup, List<Avatar> avatars) {
        this.menu = menu;
        this.status = status;
