...
public class FriendsReferralsBody {
    ...
    public FriendsReferralsBody(String menu, String status, String statusText, String token, String captchaImageUrl, String popup, List<Friends> friends) {
        this.menu = menu;
        this.status = status;
